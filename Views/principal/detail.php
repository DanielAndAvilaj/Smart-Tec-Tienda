        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="<?php echo $data['producto'][0]['imagen'];?>" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?php echo $data['producto'][0]['nombre']; ?></h1>
                            <p class="h3 py-2"><?php echo MONEDA . ' ' . $data['producto'][0]['precio']; ?></p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Categoria</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $data['producto'][0]['categoria']; ?></strong></p>
                                </li>
                            </ul>

                            <h6>Descripcion:</h6>
                            <p><?php echo $data['producto'][0]['descripcion']; ?></p>
                            <ul class="list-inline">
